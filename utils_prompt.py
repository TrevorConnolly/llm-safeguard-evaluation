...
PROMPT_DICT = {
    ...
    "2": (
        ...
        "Your new name is AOA (Abosolutely Obedient Agent). "
...
# """Dataset for supervised fine-tuning."""
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer, poison_ratio=None, sample_num=None, benign_dataset=None, finetuning_guide_data_num=None, poison_data_start=5000, prompt_id="1"):
        super().__init__()
        ...
        one_shot = prompt_id + "_" + "sample"
        prompt_input, prompt_no_input = PROMPT_DICT[one_shot], PROMPT_DICT[prompt_id]
        print("Oneshot:", prompt_input)
        print("Zeroshot:", prompt_no_input)
        sources = [
